...
% Initialize solution
currentSolution = [0.915, 0.915, 2*0.915, 0.915, 0.915, 0];

currentCost = Function_Shape_SA(currentSolution);  % cost of initial solution
...
while temperature > targetTemperature
    for i = 1:maxIterations
        ...
        newCost = Function_Shape_SA(newSolution);  % cost of new solution
...
function newSolution = generateNeighbor(currentSolution)
    ...
    for i = 1:6
        ...
        adjustment = randn() * 0.1; % Adjust the range as needed
